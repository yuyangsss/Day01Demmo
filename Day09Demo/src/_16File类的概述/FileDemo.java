...
public class FileDemo {
    public static void main(String[] args) {
        ...
        File file=new File("D:\\桌面1\\Desktop\\2018级软件工程4班刘倩.jpg");
      //  File file1=new File("D:/桌面1/Desktop/2018级软件工程4班刘倩.jpg");
        //File f1 = new File("D:"+File.separator+"itcast"+File.separator+"图片资源"+File.separator+"beautiful.jpg");
        System.out.println(file.length());

        //2.创建文件对象：使用相对路径
        File file1=new File("Day09Demo/src/dlei01.txt");
        System.out.println(file1.length());

        //3.创建文件对象：代表文件夹
        File file2=new File("D:\\桌面1\\Desktop\\2018级软件工程4班刘倩.jpg");
